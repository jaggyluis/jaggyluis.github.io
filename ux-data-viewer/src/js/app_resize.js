...
function updateInterface(e) {
  ...
  //bottom.style.height = interface.clientHeight - (left.clientHeight + 30) + "px";

  legend.style.bottom = bottom.clientHeight + 20 + "px";
  legend.style.left = left.clientWidth + 34 + "px";
  legend.style.width = interface.clientWidth - left.clientWidth - 34 + "px";
...
function loadDataLayer(data, label, open) {
  ...
  downloadImg.classList.add("axis-menu-img");
  downloadImg.src = "img/export-icon.png";

  var downloadButton = document.createElement("div");
  downloadButton.classList.add("axis-menu-item");
  downloadButton.title = "Download";
  downloadButton.style = "float : right; padding-left: 15px; ";
  downloadButton.appendChild(downloadImg);

  boxLabel.appendChild(downloadButton);

  var sheetImg = document.createElement("img");
  sheetImg.classList.add("axis-menu-img");
  sheetImg.src = "img/sheet-icon.png";

  var sheetButton = document.createElement("div");
  sheetButton.classList.add("axis-menu-item");
  sheetButton.title = "Sheet";
  sheetButton.style = "float : right; padding-left: 15px; ";
  sheetButton.appendChild(sheetImg);

  boxLabel.appendChild(sheetButton);

  var filterImg = document.createElement("img");
  filterImg.classList.add("axis-menu-img");
  ...
  filterButton.classList.add("axis-menu-item");
  filterButton.title = "Parcoods";
  filterButton.style = "float : right; padding-left: 15px;";
  filterButton.appendChild(filterImg);

  boxLabel.appendChild(filterButton);
